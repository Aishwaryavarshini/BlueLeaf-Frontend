...
const SUBJECTS_DATA = [
  { 
    name: 'Mathematics', 
    image: 'https://i.postimg.cc/QdjP0D04/math-mascot.png', // Placeholder for math mascot
    color: 'from-blue-50 to-white'
  },
  { 
    name: 'Science', 
    image: 'https://i.postimg.cc/mD8p426y/science-mascot.png', // Placeholder for science mascot
    color: 'from-blue-50 to-white'
  },
  { 
    name: 'Tamil', 
    image: 'https://i.postimg.cc/B6KkR7B6/tamil-mascot.png', // Placeholder for tamil mascot
    color: 'from-blue-50 to-white'
  },
  { 
    name: 'English', 
    image: 'https://i.postimg.cc/TY40G83L/english-mascot.png', // Placeholder for english mascot
    color: 'from-blue-50 to-white'
  },
  { 
    name: 'Social Science', 
    image: 'https://i.postimg.cc/vB22K7h0/social-mascot.png', // Placeholder for social mascot
    color: 'from-blue-50 to-white'
  }
];
